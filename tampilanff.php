        ...
        <div class="right-section">
            ...
            <div class="section-item" id="section3">
                ...
                <div class="services-container">
                    <div class="services-box" onclick="selectItem('Diamond','901')">
                        <i class='bx bxs-diamond' style="color: #007BFF;"></i>
                        <h3>5 Diamond</h3>
                        <p>Rp. 901</p> 
                    </div>
                    <div class="services-box" onclick="selectItem('Diamond','1.802')">
                        <i class='bx bxs-diamond' style="color: #007BFF;"></i>
                        <h3>12 Diamond</h3>
                        <p>Rp. 1.802</p> 
                    </div>
                    ...
                    <div class="services-box" onclick="selectItem('Diamond','9.009')">
                        <i class='bx bxs-diamond' style="color: #007BFF;"></i>
                        <h3>70 Diamond</h3>
                        <p>Rp. 9.009</p> 
                    </div>
                    <div class="services-box" onclick="selectItem('Diamond','18.018')">
                        <i class='bx bxs-diamond' style="color: #007BFF;"></i>
                        <h3>140 Diamond</h3>
                        <p>Rp. 18.018</p> 
                    </div>
                    <div class="services-box" onclick="selectItem('Diamond','45.045')">
                        <i class='bx bxs-diamond' style="color: #007BFF;"></i>
                        <h3>355 Diamond</h3>
                        <p>Rp. 45.045</p> 
                    </div>

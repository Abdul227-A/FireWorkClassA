...
<body>
    ...
    <div class="container">
        <div class="left-section">
            ...
            <h1 style="color: #007BFF; font-size: 24px; margin-bottom: 10px;">Top Up Bonds di AraStore</h1>
            <p style="color: #ffff; font-size: 16px; line-height: 1.6; margin-bottom: 20px;">
                <strong>Top Arena Brekout: Cepat, Mudah, Aman, dan terpercaya di AraStore!</strong><br>
                Top up sekarang dan lengkapi peralatan tempur kamu dengan senjata dan armor terbaik di Bonds! Jadilah yang paling tangguh di setiap pertempuran
            </p>
            ...
            <p class="confirmation">
                Konfirmasi pembayaran Anda, dan Diamond akan langsung ditambahkan ke akun Arenna breakout Anda. <strong>Top up sekarang dan tingkatkan pengalaman bermain Anda!</strong>
            </p>
        </div>
        <div class="right-section">
            ...
            <div class="section-item" id="section3">
                ...
                <div class="services-container">
                    <div class="services-box" onclick="selectItem('Bonds','16.500')">
                        <img src="images/itemhtml/goldblosstrike-Photoroom.png" alt="">
                        <h3>60 Bonds</h3>
                        <p>Rp. 16.500</p> 
                    </div>
                    <div class="services-box" onclick="selectItem('Bonds','82.500')">
                        <img src="images/itemhtml/goldblosstrike-Photoroom.png" alt="">
                        <h3>310 Bonds</h3>
                        <p>Rp. 82.500</p> 
                    </div>
                    <div class="services-box" onclick="selectItem('Bonds','165.00')">
                        <img src="images/itemhtml/goldblosstrike-Photoroom.png" alt="">
                        <h3>630 Bonds</h3>
                        <p>Rp. 165.00</p> 
                    </div>
                    <div class="services-box" onclick="selectItem('Bonds','412.500')">
                        <img src="images/itemhtml/goldblosstrike-Photoroom.png" alt="">
                        <h3>1580 Bonds</h3>
                        <p>Rp. 412.500</p> 
                    </div>
                    <div class="services-box" onclick="selectItem('Bonds','825.000')">
                        <img src="images/itemhtml/goldblosstrike-Photoroom.png" alt="">
                        <h3>3200 Bonds</h3>
                        <p>Rp. 825.000</p> 
                    </div>
                    <div class="services-box" onclick="selectItem('Bonds','61.650.000')">
                        <img src="images/itemhtml/goldblosstrike-Photoroom.png" alt="">
                        <h3>6500 Bonds</h3>
                        <p>Rp. 1.650.000</p> 
                    </div>
...
<script src="js/index.js"></script>
    ...
    <script>
        ...
        function confirmOrder() {
            document.getElementById('hiddengame').value="ArenaBreakout";
